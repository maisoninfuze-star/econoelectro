...
- Excludes promotional flyer images (price baked into the artwork) from galleries; keeps them in the source file. Two flyers containing a real photo of the unit are cropped to the photo.
