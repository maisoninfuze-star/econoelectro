...
| Studio variants (optional) | `…/<slug>/<format>-studio.png` | Same layout, background removed by fal.ai, appliance on a soft studio backdrop. Only for products with a **reviewed** cutout. |
...
- `scripts/export-meta-ads.mjs`, `scripts/fal-cutouts.mjs` — exporters
